...
urlpatterns = [
    ...
    path('reset/<uidb64', auth_views.PasswordResetConfirmView.as_view(template_name='password/reset.html'), name="password_reset_confirm"),

    path('reset_password_complete/', auth_views.PasswordResetConfirmView.as_view(template_name='password/reset_password_complete.html'), name="password_reset_complete"),
